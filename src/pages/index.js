...
export default function Home() {
  return (
    <>
      <Head>
        <title>Portfolio | Somnath Biswas</title>
        ...
        <Layout className='pt-0 md:pt-16 sm:pt-8'>
          <div className='flex items-center justify-between w-full lg:flex-col'>
            <div className='w-1/2 md:w-full '>
              <Image src={profilePic} alt="Somnath" className='w-full h-auto lg:hidden md:inline-block md:w-full'
              priority
            ...
            <div className='w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center'>
              <AnimatedText text="Transforming vision into reality through coding & design." className='!text-6xl !text-left 
...
Explore my latest projects and articles, showcasing my expertise in React.js and web development.</p>
            <div className='flex items-center self-start mt-2 lg:self-center'>
              <Link href="/Resume SB.pdf" target={'_blank'}
              ...
              <Link href="https://x.com/HelloSomnath?t=9klg3c6sTaiMjhLeq2LuHA&s=09" target={'_blank'}
        ...
        <div className='absolute right-8 bottom-8 inline-block w-24 md:hidden'>
          <Image src={lightBulb} alt='Somnath' className='w-full h-auto'/>
        </div>
      </main>
    </>
  )
